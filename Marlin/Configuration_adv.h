 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  240    //ANL           // (seconds)
 ...
 */
  ...
  #define Y_DUAL_ENDSTOPS          //ANL // Y2 has its own endstop
  #if ENABLED(Y_DUAL_ENDSTOPS)
    #define Y2_STOP_PIN Y_MIN_PIN   // Y2 endstop pin override
 ...
 */
#define INPUT_SHAPING_X //ANL
#define INPUT_SHAPING_Y //ANL
//#define INPUT_SHAPING_Z
#if ANY(INPUT_SHAPING_X, INPUT_SHAPING_Y, INPUT_SHAPING_Z)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  40.0  //ANL      // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15 //ANL      // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  40.0  //ANL      // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y   0.15 //ANL       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  ...
  #define SHAPING_MENU            //ANL    // Add a menu to the LCD to set shaping parameters.
#endif
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 600 //ANL
#define DISABLE_IDLE_X
#define DISABLE_IDLE_Y
//#define DISABLE_IDLE_Z   //ANL // Disable if the nozzle could fall onto your printed part!
 ...
 */
#define BABYSTEPPING //ANL 
#if ENABLED(BABYSTEPPING)
  //#define EP_BABYSTEPPING                 // M293/M294 babystepping with EMERGENCY_PARSER support
  #define BABYSTEP_WITHOUT_HOMING //ANL
  #define BABYSTEP_ALWAYS_AVAILABLE    //ANL   // Allow babystepping at all times (not just during movement)
  #define BABYSTEP_XY                  //ANL   // Also enable X/Y Babystepping. Not supported on DELTA!
  //#define BABYSTEP_INVERT_Z               // Enable if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  1       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING //ANL // Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_DISPLAY_TOTAL         //ANL // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET      //ANL    // Combine M851 Z and Babystepping
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_GFX_OVERLAY      //ANL    // Enable graphical overlay on Z-offset editor
  #endif
#endif
 ...
 */
#define HOST_ACTION_COMMANDS //ANL
