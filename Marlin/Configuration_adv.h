 ...
 */
  ...
  #define Y_DUAL_ENDSTOPS           // Y2 has its own endstop //ANL
  #if ENABLED(Y_DUAL_ENDSTOPS)
    #define Y2_USE_ENDSTOP    _YMIN_  // Y2 endstop board plug. Don't forget to enable USE_*_PLUG. //ANL
...
#define BABYSTEPPING //ANL
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) //ANL
  #define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA! //ANL
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  1       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. //ANL
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //ANL

  #define BABYSTEP_ZPROBE_OFFSET      //ANL    // Combine M851 Z and Babystepping
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY  //ANL // Enable graphical overlay on Z-offset editor
  #endif
#endif
