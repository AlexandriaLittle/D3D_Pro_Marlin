...
#define STRING_CONFIG_H_AUTHOR "Alexandria Little" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  A4988 //ANL
#define Y_DRIVER_TYPE  A4988 //ANL
#define Z_DRIVER_TYPE  A4988 //ANL
//#define X2_DRIVER_TYPE A4988
#define Y2_DRIVER_TYPE A4988 //ANL
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //ANL
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //ANL
#define Y_MAX_ENDSTOP_HIT_STATE LOW //ANL
#define Z_MIN_ENDSTOP_HIT_STATE LOW //ANL
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW //ANL
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2 //ANL
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 108.51 } //ANL
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 300, 25 } //ANL
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 3000, 10000 } //ANL
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -54, 11, 0 } //ANL
...
#define Z_PROBE_ERROR_TOLERANCE     5 //ANL // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT -20  //ANL // (mm) Farthest distance below the trigger-point to go before stopping
...
#define Z_CLEARANCE_FOR_HOMING  0  //ANL   // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define AUTO_BED_LEVELING_BILINEAR //ANL
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID //ANL

    //
    // Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION //ANL
  ...
  #define MESH_INSET 5              // Set Mesh bounds as an inset region of the bed //ANL
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (12*60) } //ANL
